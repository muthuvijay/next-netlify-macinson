...
const Header = () => {
  return (
    <header className='style-5' data-scroll-index='0'>
        ...
        <div className='row justify-content-center'>
          <div className='col-lg-8'>
            <div className='info'>
              ...
              <p>
                Macinson helps you unify your brand identity by collecting,
                storing and distributing <br /> design tokens and assets —
                automatically.
              </p>
              ...
              <div className='main-img'>
                <img
                  src='/assets/img/header/header5_page.png'
                  alt=''
                  className='page-img'
                />
                <img
      ...
      <img
        src='/assets/img/header/header5_handl.png'
        alt=''
        className='handl-img'
      />
      <img
        src='/assets/img/header/header5_handr.png'
        alt=''
        className='handr-img'
      />
    </header>
