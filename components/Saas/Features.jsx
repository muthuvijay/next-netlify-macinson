        ...
        <div className='row justify-content-center'>
          <div className='col-lg-8'>
            {isServices ? (
              ...
              <div className='section-head text-center mb-60 style-5'>
                <h2 className='mb-20'>
                  Other Awesome <span>Features</span>
                </h2>
                <p>
                  Macinson Dashboard is a powerhouse when it comes to the
                  feature list. This ensures you have every functionality you
                  need to build, run, and expand your marketplace
                </p>
              </div>
            )}
          </div>
