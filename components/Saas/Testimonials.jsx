    ...
    >
      <div className='container'>
        <div className='section-head text-center mb-60 style-5'>
          ...
          <p>
            {rtl
              ? "لقد أحببت Macinson من آلاف العملاء في جميع أنحاء العالم وحصلت على ثقة من الشركات الكبرى."
              : "Macinson loved from thoudsands customer worldwide and get trusted from big companies."}
          </p>
        </div>
      </div>
